...
function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.username || !formData.email || !formData.password || !profilePicture) {
        ...
        try {
            ...
            data.append("username", formData.username);  // <-- changed here
            data.append("email", formData.email);
            data.append("password", formData.password);  // <-- changed here
